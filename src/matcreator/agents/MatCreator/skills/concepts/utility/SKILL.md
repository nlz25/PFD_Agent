---
name: utility
description: "Concept skill covering general-purpose utility capabilities: visualization/plotting, structure format conversion, data queries, and web_frontends search. Use this to identify which utility tool skill to load for a given support task."
metadata:
  dependent_skills:
    - plot
