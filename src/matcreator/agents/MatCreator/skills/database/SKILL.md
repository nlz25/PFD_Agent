---
name: data
description: Skills for materials dataset operations using CLI tools. Query and manage ASE databases and a normalized SQLite information data (nodes/datasets/dataset_elements schema). Includes SQL composition guidance for query-info.
metadata:
  tools:
    - run_skill_script
  tags:
