---
name: tavily
description: Tavily is an AI-powered web_frontends intelligence platform providing search, content extraction, site crawling, URL mapping, and deep research. Use this skill to understand what Tavily can do and which sub-skill to load for a given web_frontends task.
metadata:
  dependent_skills:
    - tavily-cli
    - tavily-search
